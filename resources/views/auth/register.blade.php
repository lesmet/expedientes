                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('apellido1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="apellido1" type="text" class="form-control" name="apellido1" value="{{ old('apellido1') }}">
                          ...
                          <div class="form-group{{ $errors->has('apellido2') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="apellido2" type="text" class="form-control" name="apellido2" value="{{ old('apellido1') }}">
